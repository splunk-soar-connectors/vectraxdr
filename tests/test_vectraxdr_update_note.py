...
class UpdateNoteAction(unittest.TestCase):
    """Class to test the update note action."""
    ...
    def test_update_note_pass(self, mock_patch):
        """Test the valid case for the update note action.
    ...
    @patch("vectraxdr_utils.requests.patch")
    def test_update_note_notexist_note_id(self, mock_patch):
        """Test the notexidt note id case for the update note action.
    ...
    def test_update_note_invalid_entity_type(self):
        """Test the invalid case for the update note action.
