...
class MarkDetectionAction(BaseAction):
    ...
    def execute(self):
        ...
        ret_val, response = self._connector.util._mark_detection(self._action_result, [detection_id])
        ...
        return self._action_result.set_status(phantom.APP_SUCCESS, "Successfully marked detection")
