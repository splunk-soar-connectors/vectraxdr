...
class RemoveNoteAction(BaseAction):
    """Class to handle remove note action."""
    ...
    def execute(self):
        ...
        return self._action_result.set_status(phantom.APP_SUCCESS, "Successfully removed note")
