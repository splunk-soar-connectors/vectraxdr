...
This table lists the configuration variables required to operate Vectra XDR Splunk SOAR. These variables are specified when configuring a Vectra asset in Splunk SOAR.
